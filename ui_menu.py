...
class AnimatedTitleLabel(QLabel):
    ...
    def __init__(self, text, parent=None):
        ...
        self.setStyleSheet(f"color: {ColorPalette.PRIMARY};")
    ...
    def set_opacity(self, value):
        self._opacity = value
        # Use style sheet for opacity effect
        alpha = int(value * 255)
        r, g, b = 37, 99, 235  # PRIMARY color RGB
        self.setStyleSheet(f"color: rgba({r}, {g}, {b}, {alpha});")
...
class MenuModule(QWidget):
    ...
    def showEvent(self, event):
        """Handle show event to animate title."""
